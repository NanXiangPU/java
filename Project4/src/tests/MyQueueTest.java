...
public class MyQueueTest {
    ...
    public void addDifferentObjectTypes() throws Exception {
        ...
        assertEquals("Attempt to add String failed. Check that your Node data field accepts" +
                " generic Objects", "Project 4 is Fun!", mq.remove());
    ...
    public void checkPeek() throws Exception {
        ...
        assertEquals("The Head element should be 5.", new Integer(5), mq.peek());
    ...
    public void remove() throws Exception {
        ...
        assertEquals("Check the order of your Queue.", "CS180", mq.remove());

        /* Confirm the Head is now Project 4*/
        assertEquals("Check your remove method.", "Project 4", mq.peek());
